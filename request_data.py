...
URLS = {
    ...
    "comm_fin": BASE_URL.format(
        series="268dcdcf1b746c42fb990fe2107b7dad", current="07/17/2024"
    ),
    "bank_prime": BASE_URL.format(
        series="02338be6957591cdba0a59c6f09b8389", current="07/17/2024"
    ),
    "discount_window": BASE_URL.format(
        series="e048853c9a3f0734b8538f508828f298", current="07/17/2024"
    ),
    "tresury_bills": BASE_URL.format(
        series="4ab494d223ec49ec01fe09b49c6d17da", current="07/17/2024"
    ),
    "nominal_9": BASE_URL.format(
        series="bf17364827e38702b42a58cf8eaa3f78", current="07/17/2024"
    ),
    "inflation_indexed": BASE_URL.format(
        series="a5efc8cebeae2f178010054da08cb1f1", current="07/17/2024"
    ),
    "inflation_long_term": BASE_URL.format(
        series="68447ee78d1e78718e4a96db9405d605", current="07/17/2024"
    ),
}
...
def download_file(data):
    ...
    try:
        ...
        with open(f"./data/{title}/{title}.csv", mode="wb") as file:
